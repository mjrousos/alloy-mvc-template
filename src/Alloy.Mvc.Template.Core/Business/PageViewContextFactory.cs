...
namespace AlloyTemplates.Business
{
    public class PageViewContextFactory
    {
        ...
        public virtual LayoutModel CreateLayoutModel(ContentReference currentContentLink, ActionContext requestContext)
        {
        ...
        private string GetLoginUrl(ContentReference returnToContentLink)
        {
            return string.Format(
                "{0}?ReturnUrl={1}",
                CookieAuthenticationDefaults.LoginPath, // ( or Global.AppRelativeLoginPath)
